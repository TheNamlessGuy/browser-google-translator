const Communication = {
  ...
  _map: {
    ...
    'languages--translate-choices':      async function() { return {result: await Languages.translate.choices()}; },
    'languages--translate-page-choices': async function() { return {result: await Languages.translatePage.choices()}; },
    'languages--tts-choices':            async function() { return {result: await Languages.tts.choices()}; },
  },
};